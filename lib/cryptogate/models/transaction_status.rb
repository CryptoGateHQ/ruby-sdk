...
module CryptoGate
  class TransactionStatus
    ...
    AWAITING_CONFIRMATION = "awaiting_confirmation".freeze
    ...
    def self.all_vars
      @all_vars ||= [PENDING, AWAITING_CONFIRMATION, COMPLETED, PARTIAL, EXPIRED, FAILED].freeze
    end
    ...
    def build_from_hash(value)
      return value if TransactionStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #TransactionStatus"
    end
  end
end
