...
module CryptoGate
  class GetStats200ResponseData
    attr_accessor :total_transactions

    attr_accessor :monthly_transactions

    attr_accessor :total_volume_fiat

    attr_accessor :unique_customers
    ...
    def self.attribute_map
      {
        ...
        :'total_volume_fiat' => :'total_volume_fiat',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoGate::GetStats200ResponseData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoGate::GetStats200ResponseData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_volume_fiat')
        self.total_volume_fiat = attributes[:'total_volume_fiat']
      end

      if attributes.key?(:'unique_customers')
        self.unique_customers = attributes[:'unique_customers']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_volume_fiat == o.total_volume_fiat &&
    ...
    def hash
      [total_transactions, monthly_transactions, total_volume_fiat, unique_customers].hash
    end
