...
module CryptoGate
  class PlanTier
    ...
    def self.all_vars
      @all_vars ||= [STARTER, BUSINESS, PROFESSIONAL, ENTERPRISE].freeze
    end
    ...
    def build_from_hash(value)
      return value if PlanTier.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PlanTier"
    end
  end
end
