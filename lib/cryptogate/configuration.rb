...
module CryptoGate
  class Configuration
    ...
    def server_settings
      [
        {
          url: "https://api.cryptogate.live/v1",
          description: "Production (live keys, mainnet)",
        },
        {
          url: "https://api.staging.cryptogate.live/v1",
          description: "Sandbox (test keys, no real funds)",
        }
      ]
    end
