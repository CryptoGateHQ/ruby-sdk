...
# Unit tests for CryptoGate::DefaultApi
...
describe 'DefaultApi' do
  ...
  describe 'test an instance of DefaultApi' do
    it 'should create an instance of DefaultApi' do
      expect(@api_instance).to be_instance_of(CryptoGate::DefaultApi)
    end
  end

  # unit tests for payment_webhook
  ...
  # @return [nil]
  describe 'payment_webhook test' do
    it 'should work' do
