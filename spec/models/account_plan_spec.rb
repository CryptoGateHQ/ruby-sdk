...
# Unit tests for CryptoGate::AccountPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::AccountPlan do
  let(:instance) { CryptoGate::AccountPlan.new }

  describe 'test an instance of AccountPlan' do
    it 'should create an instance of AccountPlan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::AccountPlan)
    end
  end
