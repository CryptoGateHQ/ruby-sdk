...
# Unit tests for CryptoGate::WebhookPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::WebhookPayload do
  let(:instance) { CryptoGate::WebhookPayload.new }

  describe 'test an instance of WebhookPayload' do
    it 'should create an instance of WebhookPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::WebhookPayload)
    end
  end
  ...
  describe 'test attribute "event"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["payment.created", "payment.pending", "payment.completed", "payment.overpaid", "payment.partial", "payment.expired", "payment.failed"])
  ...
  describe 'test attribute "currency_crypto"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "currency_fiat"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "amount_fiat"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "amount_crypto"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
