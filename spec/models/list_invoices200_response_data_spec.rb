...
# Unit tests for CryptoGate::ListInvoices200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListInvoices200ResponseData do
  let(:instance) { CryptoGate::ListInvoices200ResponseData.new }

  describe 'test an instance of ListInvoices200ResponseData' do
    it 'should create an instance of ListInvoices200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListInvoices200ResponseData)
    end
  end
