...
# Unit tests for CryptoGate::GetPrices200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::GetPrices200ResponseData do
  let(:instance) { CryptoGate::GetPrices200ResponseData.new }

  describe 'test an instance of GetPrices200ResponseData' do
    it 'should create an instance of GetPrices200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::GetPrices200ResponseData)
    end
  end
