...
# Unit tests for CryptoGate::InlineObjectAllOfExistingTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::InlineObjectAllOfExistingTransaction do
  let(:instance) { CryptoGate::InlineObjectAllOfExistingTransaction.new }

  describe 'test an instance of InlineObjectAllOfExistingTransaction' do
    it 'should create an instance of InlineObjectAllOfExistingTransaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::InlineObjectAllOfExistingTransaction)
    end
  end
