...
# Unit tests for CryptoGate::Invoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::Invoice do
  let(:instance) { CryptoGate::Invoice.new }

  describe 'test an instance of Invoice' do
    it 'should create an instance of Invoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::Invoice)
    end
  end
  ...
  describe 'test attribute "crypto_symbol"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
