...
# Unit tests for CryptoGate::CryptoSymbol
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::CryptoSymbol do
  let(:instance) { CryptoGate::CryptoSymbol.new }

  describe 'test an instance of CryptoSymbol' do
    it 'should create an instance of CryptoSymbol' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::CryptoSymbol)
    end
  end
