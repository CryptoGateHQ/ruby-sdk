...
# Unit tests for CryptoGate::GetPrices200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::GetPrices200Response do
  let(:instance) { CryptoGate::GetPrices200Response.new }

  describe 'test an instance of GetPrices200Response' do
    it 'should create an instance of GetPrices200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::GetPrices200Response)
    end
  end
