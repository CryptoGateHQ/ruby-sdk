...
# Unit tests for CryptoGate::ListBalances200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListBalances200ResponseData do
  let(:instance) { CryptoGate::ListBalances200ResponseData.new }

  describe 'test an instance of ListBalances200ResponseData' do
    it 'should create an instance of ListBalances200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListBalances200ResponseData)
    end
  end
