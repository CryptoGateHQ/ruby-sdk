...
# Unit tests for CryptoGate::CreateBillingCheckoutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::CreateBillingCheckoutRequest do
  let(:instance) { CryptoGate::CreateBillingCheckoutRequest.new }

  describe 'test an instance of CreateBillingCheckoutRequest' do
    it 'should create an instance of CreateBillingCheckoutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::CreateBillingCheckoutRequest)
    end
  end
  ...
  describe 'test attribute "billing_months"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
