...
# Unit tests for CryptoGate::CreateTransactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::CreateTransactionRequest do
  let(:instance) { CryptoGate::CreateTransactionRequest.new }

  describe 'test an instance of CreateTransactionRequest' do
    it 'should create an instance of CreateTransactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::CreateTransactionRequest)
    end
  end
