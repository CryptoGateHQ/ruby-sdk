...
# Unit tests for CryptoGate::Cryptocurrency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::Cryptocurrency do
  let(:instance) { CryptoGate::Cryptocurrency.new }

  describe 'test an instance of Cryptocurrency' do
    it 'should create an instance of Cryptocurrency' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::Cryptocurrency)
    end
  end
