...
# Unit tests for CryptoGate::ListTransactions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListTransactions200Response do
  let(:instance) { CryptoGate::ListTransactions200Response.new }

  describe 'test an instance of ListTransactions200Response' do
    it 'should create an instance of ListTransactions200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListTransactions200Response)
    end
  end
