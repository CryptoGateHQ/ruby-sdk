...
# Unit tests for CryptoGate::AccountLimits
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::AccountLimits do
  let(:instance) { CryptoGate::AccountLimits.new }

  describe 'test an instance of AccountLimits' do
    it 'should create an instance of AccountLimits' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::AccountLimits)
    end
  end
