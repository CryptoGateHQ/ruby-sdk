...
# Unit tests for CryptoGate::TransactionStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::TransactionStatus do
  let(:instance) { CryptoGate::TransactionStatus.new }

  describe 'test an instance of TransactionStatus' do
    it 'should create an instance of TransactionStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::TransactionStatus)
    end
  end
