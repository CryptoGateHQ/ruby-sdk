...
# Unit tests for CryptoGate::PaymentSplit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::PaymentSplit do
  let(:instance) { CryptoGate::PaymentSplit.new }

  describe 'test an instance of PaymentSplit' do
    it 'should create an instance of PaymentSplit' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::PaymentSplit)
    end
  end
