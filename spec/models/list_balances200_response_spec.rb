...
# Unit tests for CryptoGate::ListBalances200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListBalances200Response do
  let(:instance) { CryptoGate::ListBalances200Response.new }

  describe 'test an instance of ListBalances200Response' do
    it 'should create an instance of ListBalances200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListBalances200Response)
    end
  end
