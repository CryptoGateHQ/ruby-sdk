...
# Unit tests for CryptoGate::LineItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::LineItem do
  let(:instance) { CryptoGate::LineItem.new }

  describe 'test an instance of LineItem' do
    it 'should create an instance of LineItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::LineItem)
    end
  end
