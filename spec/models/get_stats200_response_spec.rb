...
# Unit tests for CryptoGate::GetStats200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::GetStats200Response do
  let(:instance) { CryptoGate::GetStats200Response.new }

  describe 'test an instance of GetStats200Response' do
    it 'should create an instance of GetStats200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::GetStats200Response)
    end
  end
