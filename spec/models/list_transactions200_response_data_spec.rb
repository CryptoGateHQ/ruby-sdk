...
# Unit tests for CryptoGate::ListTransactions200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListTransactions200ResponseData do
  let(:instance) { CryptoGate::ListTransactions200ResponseData.new }

  describe 'test an instance of ListTransactions200ResponseData' do
    it 'should create an instance of ListTransactions200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListTransactions200ResponseData)
    end
  end
