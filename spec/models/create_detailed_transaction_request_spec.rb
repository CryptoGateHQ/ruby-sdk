...
# Unit tests for CryptoGate::CreateDetailedTransactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::CreateDetailedTransactionRequest do
  let(:instance) { CryptoGate::CreateDetailedTransactionRequest.new }

  describe 'test an instance of CreateDetailedTransactionRequest' do
    it 'should create an instance of CreateDetailedTransactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::CreateDetailedTransactionRequest)
    end
  end
