...
# Unit tests for CryptoGate::Balance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::Balance do
  let(:instance) { CryptoGate::Balance.new }

  describe 'test an instance of Balance' do
    it 'should create an instance of Balance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::Balance)
    end
  end
