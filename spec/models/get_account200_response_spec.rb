...
# Unit tests for CryptoGate::GetAccount200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::GetAccount200Response do
  let(:instance) { CryptoGate::GetAccount200Response.new }

  describe 'test an instance of GetAccount200Response' do
    it 'should create an instance of GetAccount200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::GetAccount200Response)
    end
  end
