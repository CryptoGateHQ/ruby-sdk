...
# Unit tests for CryptoGate::ListInvoices200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListInvoices200Response do
  let(:instance) { CryptoGate::ListInvoices200Response.new }

  describe 'test an instance of ListInvoices200Response' do
    it 'should create an instance of ListInvoices200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListInvoices200Response)
    end
  end
