...
# Unit tests for CryptoGate::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::Pagination do
  let(:instance) { CryptoGate::Pagination.new }

  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::Pagination)
    end
  end
