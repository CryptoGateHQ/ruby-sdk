...
# Unit tests for CryptoGate::TransactionEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::TransactionEnvelope do
  let(:instance) { CryptoGate::TransactionEnvelope.new }

  describe 'test an instance of TransactionEnvelope' do
    it 'should create an instance of TransactionEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::TransactionEnvelope)
    end
  end
