...
# Unit tests for CryptoGate::GetHealth200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::GetHealth200Response do
  let(:instance) { CryptoGate::GetHealth200Response.new }

  describe 'test an instance of GetHealth200Response' do
    it 'should create an instance of GetHealth200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::GetHealth200Response)
    end
  end
