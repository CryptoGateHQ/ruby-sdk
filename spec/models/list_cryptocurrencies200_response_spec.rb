...
# Unit tests for CryptoGate::ListCryptocurrencies200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListCryptocurrencies200Response do
  let(:instance) { CryptoGate::ListCryptocurrencies200Response.new }

  describe 'test an instance of ListCryptocurrencies200Response' do
    it 'should create an instance of ListCryptocurrencies200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListCryptocurrencies200Response)
    end
  end
