...
# Unit tests for CryptoGate::AccountUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::AccountUsage do
  let(:instance) { CryptoGate::AccountUsage.new }

  describe 'test an instance of AccountUsage' do
    it 'should create an instance of AccountUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::AccountUsage)
    end
  end

  describe 'test attribute "monthly_transactions_used"' do
    it 'should work' do
