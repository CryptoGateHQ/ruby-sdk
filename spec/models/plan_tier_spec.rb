...
# Unit tests for CryptoGate::PlanTier
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::PlanTier do
  let(:instance) { CryptoGate::PlanTier.new }

  describe 'test an instance of PlanTier' do
    it 'should create an instance of PlanTier' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::PlanTier)
    end
  end
