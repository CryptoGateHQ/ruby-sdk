...
# Unit tests for CryptoGate::GetStats200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::GetStats200ResponseData do
  let(:instance) { CryptoGate::GetStats200ResponseData.new }

  describe 'test an instance of GetStats200ResponseData' do
    it 'should create an instance of GetStats200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::GetStats200ResponseData)
    end
  end
  ...
  describe 'test attribute "total_volume_fiat"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "unique_customers"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
