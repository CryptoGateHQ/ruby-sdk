...
# Unit tests for CryptoGate::FiatCurrency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::FiatCurrency do
  let(:instance) { CryptoGate::FiatCurrency.new }

  describe 'test an instance of FiatCurrency' do
    it 'should create an instance of FiatCurrency' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::FiatCurrency)
    end
  end
