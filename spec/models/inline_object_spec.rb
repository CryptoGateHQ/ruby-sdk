...
# Unit tests for CryptoGate::InlineObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::InlineObject do
  let(:instance) { CryptoGate::InlineObject.new }

  describe 'test an instance of InlineObject' do
    it 'should create an instance of InlineObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::InlineObject)
    end
  end
  ...
  describe 'test attribute "existing_transaction"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
