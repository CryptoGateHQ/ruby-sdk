...
# Unit tests for CryptoGate::ListPlans200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListPlans200Response do
  let(:instance) { CryptoGate::ListPlans200Response.new }

  describe 'test an instance of ListPlans200Response' do
    it 'should create an instance of ListPlans200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListPlans200Response)
    end
  end
