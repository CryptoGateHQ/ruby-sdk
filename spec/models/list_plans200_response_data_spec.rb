...
# Unit tests for CryptoGate::ListPlans200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoGate::ListPlans200ResponseData do
  let(:instance) { CryptoGate::ListPlans200ResponseData.new }

  describe 'test an instance of ListPlans200ResponseData' do
    it 'should create an instance of ListPlans200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CryptoGate::ListPlans200ResponseData)
    end
  end
